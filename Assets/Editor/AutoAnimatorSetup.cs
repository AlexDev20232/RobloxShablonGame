...
{
    private const string ControllerPath = "Assets/CharacterController.controller";
    private const string IdleClipPath = "Assets/Idle.anim";
    private const string RunClipPath = "Assets/Run.anim";
    private const string PlayerName = "bacon@T-Pose (1)";
    private const string ModelPath = "Assets/bacon@T-Pose (1).fbx";
